...
formatter = {
    ...
    'Games Played': ('G', {'width': 5, 'cellStyle': agstyler.highlight(Color.RED_LIGHT.value,
                                                                                   condition_two_value)}),
    'Rushing Efficiency': ('Rushing Eff', {'width': 50, 'cellStyle': agstyler.highlight(Color.GREEN_LIGHT.value,
                                                                                                                condition_one_value)}),
    'Receiving Efficiency': ('Receiving Eff', {'width': 50, 'cellStyle': agstyler.highlight(Color.GREEN_LIGHT.value,
                                                                                                                condition_one_value)}),
    'Rushing Explosiveness': ('Rushing Exp', {'width': 50, 'cellStyle': agstyler.highlight(Color.GREEN_LIGHT.value,
                                                                                                                condition_one_value)}),
    'Receiving Explosiveness': ('Receiving Exp', {'width': 50, 'cellStyle': agstyler.highlight(Color.GREEN_LIGHT.value,
                                                                                                                condition_one_value)}),
